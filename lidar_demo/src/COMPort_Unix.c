...
/* FIXME Added baudrate as parameter for more configuration options*/
int32_t com_open(const char* port_name, unsigned long baudrate)
{
    int com_port_handle;
    ...
    /* FIXME calling functions to set baudrate*/
                    ...
                    void* data, size_t num_requested_bytes)
{
        ...
        (handles[port_handle] != -1))
    {
        ...
        {
            int32_t num_bytes = read(handles[port_handle],
